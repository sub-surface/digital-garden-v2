...
This essay argues that attention is not a resource to be managed but a mode of being — a way of being present to the world that constitutes, rather than merely accompanies, genuine thought. To lose the capacity for attention is not to lose a tool. It is to lose a self.
...
James's formulation is instructive because it locates attention in the will — but this already assumes too much. It implies that attention is primarily a voluntary act, something we *do* to the world. This misses the passive dimension: the ways in which the world *calls forth* attention, in which some things strike us as worthy of notice before any act of will has occurred.
...
This maps surprisingly well onto what we know about the phenomenology of social media use: not mere distraction but a peculiar self-referential loop, in which the apparent engagement with others is actually an intensified attention to one's own image in their eyes.

---

## Attention and Thinking

The connection between attention and genuine thought is something [[Wittgenstein]] gestures toward in *Philosophical Investigations*, though obliquely. His critique of the idea that meaning is a private mental process carries implications for attention: if meaning is constituted in practice, in forms of life, then the conditions for meaningful thought are partly external — they depend on the kind of sustained engagement with problems that distracted scrolling systematically forecloses.
...
This is not an argument for obscurantism. Unnecessary difficulty is just bad writing. But necessary difficulty — the difficulty that inheres in the subject matter itself, that cannot be removed without falsifying it — is something to be preserved, not apologised for.
