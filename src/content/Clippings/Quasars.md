---
title: Quasars
source: https://docs.openspaceproject.com/latest/content/universe/deep-sky-surveys/quasars/index.html
author:
...
type: article
---
NOTE: This page is an article clipping from the [OpenSpace project](https://docs.openspaceproject.com/latest/index.html).  

Quasars— OpenSpace documentation ([latest](https://docs.openspaceproject.com/latest/content/universe/deep-sky-surveys/quasars/index.html))

Scene ‣ Universe ‣ Deep Sky Surveys ‣ Quasars
...
![A two-lobed distribution of the quasars as orange points along with the Sloan DSS Galaxies embedded within to give us a sense of scale.](https://docs.openspaceproject.com/latest/_images/quasars%2Bgalaxies.png)

The distribution of quasars, in orange, along with the [[Sloan DSS Galaxies]], in green, for scale. The data are bifurcated because of the zone of avoidance, that part of the sky where the band of the Milky Way blocks our view of the galaxies beyond our own. 
...
We do not see quasars near the Milky Way Galaxy. Their distances typically range from roughly 500 million light years to over 30 billion light years (if 30 billion confounds you, see the below). These distances are so great that the light travel time becomes a factor in our understanding of them.

![The quasar points plotted with a 20-billion-light-year grid.](https://docs.openspaceproject.com/latest/_images/quasars_grid.png)
...
| --- | --- |
| Asset File: | `data/assets/scene/digitaluniverse/quasars.asset` |
| OpenSpace Version: | 3 |
...
| Source Version: | 4.07 |
| License: | [AMNH’s Digital Universe](https://www.amnh.org/research/hayden-planetarium/digital-universe/download/digital-universe-license) |
